<template>
  <div class="json-check" @click="isHistoryShow = false">
    <a-spin :spinning="loading">
      <top-menu class="top-menu"
                ref="topMenu"
                :header-field-data="headerFieldData"
                :header-field-object="headerFieldObject"
                @pushSendRequest="getSendRequest"
                @pushHeaderField="getHeaderField"
                @changeSendRequestClass="isHttpURL"
                @disAbleFavoriteClass="changeFavoriteBtn"
                @cancelHeaderField="cancelHeaderField"></top-menu>
      <div class="center"
        ...
        <div class="request">
          ...
          <div class="request-input">
            <table border="0">
              <tr>
                ...
                <td class="select">
                  <a-button @click.stop="isHistoryShow =! isHistoryShow"
          ...
          <div class="request-note"
            ...
            <a-tag v-for="(hfitem, hfindex) in headerFieldData"
                   :key="hfindex"
                    >
                    <a class="header-field-note"  @click="toHeaderFieldModel(hfitem)">
  ...
  export default {
    ...
    data() {
      return{
        ...
        headerFieldObject: {}, // 请求头对象参数，用作回显子组件传参
    ...
    methods: {
      ...
      // 点击请求头显示弹窗
      toHeaderFieldModel(hfitem){
        this.headerFieldObject = hfitem
        this.headerFieldObject.switch = true
        // this.$refs.topMenu.getHeaderField()
      },
      // 删除请求头
      ...
      cancelHeaderField(){
        this.headerFieldObject.switch = false
        console.log(this.headerFieldObject)
      },
      // ------------ 工具 -------------
      isJsonString(str) {
        try {
